 ...
 *   - cookie_auth: []
 */
export declare const GET: (req: MedusaRequest<AdminGetAttributesParamsType>, res: MedusaResponse) => Promise<MedusaResponse>;
/**
 ...
 *   - cookie_auth: []
 */
export declare const POST: (req: MedusaRequest<AdminCreateAttributeType>, res: MedusaResponse) => Promise<void>;
