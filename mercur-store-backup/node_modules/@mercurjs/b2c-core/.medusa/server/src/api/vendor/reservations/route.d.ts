...
import { VendorCreateReservationType, VendorGetReservationParamsType } from './validators';
/**
 ...
 *   - cookie_auth: []
 */
export declare const GET: (req: AuthenticatedMedusaRequest<VendorGetReservationParamsType>, res: MedusaResponse) => Promise<void>;
/**
 ...
 *   - cookie_auth: []
 */
export declare const POST: (req: AuthenticatedMedusaRequest<VendorCreateReservationType>, res: MedusaResponse) => Promise<void>;
