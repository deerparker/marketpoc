...
import { VendorGetProductParamsType, VendorUpdateProductType } from "../validators";
/**
 ...
 *   - cookie_auth: []
 */
export declare const POST: (req: AuthenticatedMedusaRequest<VendorUpdateProductType>, res: MedusaResponse) => Promise<void>;
/**
